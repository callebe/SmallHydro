<table style="width:80%" align="center" class="table">
	...
	<tbody>
		...
		<tr>
		    ...
		    In addition, it is possible to enter initial investment data, the price of the energy to be sold, for an economic analysis of the investment. Taking the VAL as the residual value at the end of the useful life of the mini hydropower plant, and the IRR, which is the internal rate of return, the highest possible value for the discount rate that would lead to the investment unfeasible.<br><br>
			This program show a comparative with the system with one and two equal turbines in the same hydraulic exploitation.<br><br><br></td>
		</tr>
	</tbody>
</table>