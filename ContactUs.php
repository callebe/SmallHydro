            ...
            <ul class="list-group" id="contact-list">
                <li class="list-group-item">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        ...
                        <a href="http://www.jquery2dotnet.com" class="skype"><i class="fa fa-skype"></i>  callebe_7<br></a>
                        <a href="skype:callebe_7?call" class="linkedin"><i class="fa fa-linkedin"></i>  callebe-barbosa<br></a>
                    </div>
